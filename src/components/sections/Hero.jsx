...
const Hero = () => {
    return (
        <section className="mt-12 sm:mt-[0vw]">
            <div className="container grid grid-cols-2 sm:grid-cols-1 sm:grid-rows-2 pt-68 sm:pt-[8vw] pb-85 sm:pb-[12vw] pl-43 sm:pr-[3vw] bg-[linear-gradient(98deg,_rgba(245,245,245,0.50)_-23.46%,_rgba(245,245,245,0.50)_107.51%)] sm:gap-93">
